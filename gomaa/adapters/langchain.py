"""
LangChain & LangGraph Memory Adapter for Gomaa.
...
class GomaaMemory:
    ...
    Uses Gomaa's hybrid search and token-budgeted context assembler.
    """
    ...
    def save_context(self, inputs: Dict[str, Any], outputs: Dict[str, Any]) -> None:
        """Save a user/assistant turn into Gomaa."""
