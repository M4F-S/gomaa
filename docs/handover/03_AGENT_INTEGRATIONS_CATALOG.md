...
mcp_servers:
  obsidian_memory:
    ...
    env:
      MEMORY_DB_DSN: postgresql://<DB_USER>:<DB_PASSWORD>@<POSTGRES_INTERNAL_IP>:5432/toy_db
...
mem.remember(
    ...
    content="Use Docker bridge network <POSTGRES_SUBNET> for PostgreSQL inter-container traffic.",
    wing="devops",
    room="networking",
    tags=["infra", "docker"],
    pinned=True
